...
class Application(tornado.web.Application):
    ...
    # log_request is called after each request. By default, it uses the tornado
    # logger to write to stdout, but we can inject a call to libhoney here
...
class BaseHandler(tornado.web.RequestHandler):
    ...
    # log_exception can be overridden to send errors to Honeycomb
    # It is implemented in the Handler, but since all handlers in this app
    # are derived from this BaseHandler class, we only have to instrument
    # it here
...
async def main():
    # init libhoney and override the default Transmission implementation with
    # TornadoTransmission, which uses the Tornado IOLoop instead of a
    # threadpool
    libhoney.init(
        writekey="abcdefghijklmnopqrstuvwxyz",
        dataset="tornado-blog",
